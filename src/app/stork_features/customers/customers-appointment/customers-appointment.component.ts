...
@Component({
  selector: 'app-customers-appointment',
  templateUrl: './customers-appointment.component.html',
  styleUrls: ['./customers-appointment.component.scss'],
  providers:[CustomerService]
})
export class CustomersAppointmentComponent implements OnInit {
  customerid: any;
  customer:any;
