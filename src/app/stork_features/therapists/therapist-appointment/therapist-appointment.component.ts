...
@Component({
  selector: 'app-therapist-appointment',
  templateUrl: './therapist-appointment.component.html',
  styleUrls: ['./therapist-appointment.component.scss'],
  providers:[TherapistsService]
})
export class TherapistAppointmentComponent implements OnInit {
  lastname: any;
  firstname: any;
  therapistId: any;
  therapist:any;
  position = 'after';
   ...
   constructor(private router: Router,private route: ActivatedRoute,private therapistsService:TherapistsService) {
      if (!this.therapist) {
        this.therapist = {};
